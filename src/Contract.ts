...
const log = debug("revojs:contract")

const { logDecoder } = require("revojs-ethjs-abi") as IETHABI
...
export class Contract {
   ...
   *      [solar](https://github.com/revolutionchain/solar). It includes the contract
  ...
  /**
   * Executes contract method on your own local revod node as a "simulation"
